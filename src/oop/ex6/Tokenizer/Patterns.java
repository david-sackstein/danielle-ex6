...
public class Patterns {
    ...
    public static final String DECLARATION_INT = getDeclarationsLine("int", Assignment.OPTIONAL_INT);
    public static final String DECLARATION_STRING = getDeclarationsLine("String", Assignment.OPTIONAL_STRING);
    public static final String DECLARATION_DOUBLE = getDeclarationsLine("double", Assignment.OPTIONAL_DOUBLE);
    public static final String DECLARATION_BOOLEAN = getDeclarationsLine("boolean", Assignment.OPTIONAL_BOOLEAN);
    public static final String DECLARATION_CHAR = getDeclarationsLine("char", Assignment.OPTIONAL_CHAR);
    ...
    private static String getMethodDeclaration() {
        return getList("void" + Stam.ANY_WHITESPACES + Stam.NAME_OF_METHOD, ARGUMENT_DECLARATION, ",", "?", "\\{");
    }
